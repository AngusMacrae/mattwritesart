  ...
  return (
    <section className="about container-thin flow">
      ...
      <p>
        ...
        and just decided to start writing. I&apos;ve always enjoyed writing by hand -
        writing so much relaxes me.
      </p>
      <p>
      ...
      <p>
        Since then I&apos;ve shown my art at my first exhibition and sent prints and
        originals all across the globe. Please have a look around and if you
