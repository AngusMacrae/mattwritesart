        ...
        <nav className={clsx(menuOpen && 'active')}>
          <ul className='nav__page-links'>
            <li className='nav__home'>
              {router.pathname === "/" ? (
                <p className='active' onClick={closeMenu}>Home</p>
              ) : (
                <Link href='/'>
                  <a>Home</a>
                </Link>
            ...
            <li>
              {router.pathname === "/art" ? (
                <p className='active' onClick={closeMenu}>Browse & Buy</p>
              ) : (
                <Link href='/art'>
                  <a>Browse & Buy</a>
                </Link>
            ...
            <li>
              {router.pathname === "/commissions" ? (
                <p className='active' onClick={closeMenu}>Commissions</p>
              ) : (
            ...
            <li>
              {router.pathname === "/contact" ? (
                <p className='active' onClick={closeMenu}>Contact</p>
              ) : (
                <Link href='/contact'>
                  <a>Contact</a>
                </Link>
