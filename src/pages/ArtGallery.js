...
export default function ArtGallery() {
  ...
  const [availabilityFilter, handleAvailabilityFilterChange] = useFilter('availability', clearFilters);
  const [categoryFilter, handleCategoryFilterChange] = useFilter('category', clearFilters);
